...
class Imposter {
    ...
    _deleteOldImposter() {
        ...
        return fetch(
            `http://${this.ImposterInformation.mountebankHost}:${this.ImposterInformation.mountebankPort}/imposters/${this.ImposterInformation.imposterPort}`,
            {
                method: 'delete'
            }
        )
    ...
    postToMountebank() {
        ...
        return fetch(
            `http://${this.ImposterInformation.mountebankHost}:${this.ImposterInformation.mountebankPort}/imposters`,
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
